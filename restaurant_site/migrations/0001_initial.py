    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrateur', 'Administrateur'), ('Client', 'Client'), ('Serveur', 'Serveur'), ('Cuisinier', 'Cuisinier'), ('Caissier', 'Caissier')], default='Client', max_length=20)),
